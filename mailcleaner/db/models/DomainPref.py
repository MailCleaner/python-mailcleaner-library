...
class DomainPref(base, BaseModel):
    ...
    silent = Column(String(100), nullable=False, default="HTML-IFrame All-Viruses Zip-Password")
    ...
    content_subject = Cloumn(String(20), nullable=False, default="{Virus?}")
    warning_attach = Cloumn(Boolean, nullable=False, default=True)
    warning_filename = Cloumn(String(50), nullable=False, default="AttentionVirus.txt")
    warning_encoding_charset = Cloumn(String(20), nullable=False, default="ISO-8859-1")
    use_bayes = Cloumn(Boolean, nullable=False, default=True)
    bayes_autolearn = Cloumn(Boolean, nullable=False, default=True)
    ok_languages = Cloumn(String(50), nullable=False, default="fr en de it es")
    ok_locales = Cloumn(String(50), nullable=False, default="fr en de it es")
    use_rbls = Cloumn(Boolean, nullable=False, default=True)
    rbls_timeout = Cloumn(INTEGER(11), nullable=False, default=20)
    use_dcc = Cloumn(Boolean, nullable=False, default=True)
    dcc_timeout = Cloumn(INTEGER(11), nullable=False, default=10)
    use_razor = Cloumn(Boolean, nullable=False, default=True)
    razor_timeout = Cloumn(INTEGER(11), nullable=False, default=10)
    use_pyzor = Cloumn(Boolean, nullable=False, default=True)
    pyzor_timeout = Cloumn(INTEGER(11), nullable=False, default=10)
    auth_type = Cloumn(String(10), nullable=False, default="imap")
    auth_param = Cloumn(String(200), nullable=True)
    auth_server = Cloumn(String(100), nullable=False, default="localhost")
    auth_modif = Cloumn(String(100), nullable=False, default="localhost")
    address_fetcher = Cloumn(String(10), nullable=False, default="at_login")
