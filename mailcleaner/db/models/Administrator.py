...
class Administrator(base, BaseModel):
    ...
    can_manage_users = Column(Enum(MCBooleanStringEnum),
                              nullable=False,
                              default=MCBooleanStringEnum.true.value)
    can_manage_domains = Column(Enum(MCBooleanStringEnum),
                                nullable=False,
                                default=MCBooleanStringEnum.false.value)
    can_configure = Column(Enum(MCBooleanStringEnum),
                           nullable=False,
                           default=MCBooleanStringEnum.false.value)
    can_view_stats = Column(Enum(MCBooleanStringEnum),
                            nullable=False,
                            default=MCBooleanStringEnum.false.value)
    can_manage_host = Column(Enum(MCBooleanStringEnum),
                             nullable=False,
                             default=MCBooleanStringEnum.false.value)
    domains = Column(BLOB)
    allow_subdomains = Column(Enum(MCBooleanStringEnum),
                              nullable=False,
                              default=MCBooleanStringEnum.false.value)
