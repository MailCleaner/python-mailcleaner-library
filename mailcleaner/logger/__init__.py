...
class McLogger(object):
    ...
    loggers = set()
    def __init__(self, name: str, project: str = "", filename: str = "", path: str = "", level =INFO):
        # Initial construct.
        self.format = "%(asctime)s | {} | %(levelname)s | %(message)s".format(name)
        ...
        #Testing path
        full_path = "{}/log/{}".format(self._mc_config.get_value("VARDIR"),project)
